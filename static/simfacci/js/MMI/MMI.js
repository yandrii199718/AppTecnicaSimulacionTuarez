            ...
            function OnPronostico () {
                ...
                document.getElementById("mcap").addEventListener("click", MetodoMCAP);
                    function MetodoMCAP () {
                        ...
                        document.getElementById('formulario').action= "/MMICalcularMCAPronostico";
                    }
                ...
                document.getElementById("mcmup").addEventListener("click", MetodoMCMUP);
                    ...
                    document.getElementById("CajaMetodos").innerHTML=Metodo;
                    document.getElementById('formulario').action= "/MMICalcularMCMUPronostico";
                }
                ...
                document.getElementById("manualp").addEventListener("click", MetodoManualP);
                    ...
                    function N_Iteracciones() {
                        ...
                        inputs = "<h5 class='center'>Método Manual</h5><div class='col s12 m6'><span class='col m12 s6 center'>Aleatorios Para Demanda</span>";
                        ...
                        inputs += ""+inputsall+"</div><div class='col s12 m6'><span class='col m12 s6 center'>Aleatorios Para Retraso</span>"+inputsserv+"</div>";
                    ...
                    document.getElementById('formulario').action= "/MMICalcularManualPronostico";
                }
        ...
        <!--Script Listener Regresar Normalidad-->
            ...
            function ModoAutoProbabilidad () {
                ...
                document.getElementById('formulario').action= "/MMICalcularMCA";
                        Metodo = '';
                        Metodo += "<div class='row'> \
                            <h5 class='center'>Metodo Congruencial Adictivo</h5>    \
                            <div class='input-field col s12 m6'>\
        ...
        <!--Script Listener Metodo MCMU-->
            ...
            function MetodoMCMU () {
                ...
                document.getElementById("CajaMetodos").innerHTML=Metodo;
                document.getElementById('formulario').action= "/MMICalcularMCMU";
            }
        ...
        <!--Script Listener Metodo Manual-->
            ...
            function MetodoManual () {
                ...
                document.getElementById('formulario').action= "/MMICalcularManual";
            }
        ...
        <!--Script Listener Demanda/Pronostico-->
            ...
            function InputsForDemandaPronostico () {
                ...
                inputs_p_demanda = "<div class='col s12 m12'><h6 class='center red-text'>Ingrese Valores de Probabilidad Para Demanda</h6>";
        ...
        <!--Script Listener Demanda/Retraso-->
            ...
            function InputsForRetrasoPronostico () {
                ...
                inputs_p_retraso = "<div class='col s12 m12'><h6 class='center red-text'>Ingrese Valores de Probabilidad Para Retraso</h6>";
        ...
        <!--Iteracciones-->
           ...
           document.getElementById("In_Q").addEventListener("keyup", Validar_Datos_Inventario_KeyUp);
           document.getElementById("In_Punto_Reorden").addEventListener("keyup", Validar_Datos_Inventario_KeyUp);
           document.getElementById("In_Inventario_Inicial").addEventListener("keyup", Validar_Datos_Inventario_KeyUp);
           document.getElementById("In_Costo_Mantenimiento").addEventListener("keyup", Validar_Datos_Inventario_KeyUp);
           document.getElementById("In_Costo_Ordenar").addEventListener("keyup", Validar_Datos_Inventario_KeyUp);
           document.getElementById("In_Costo_Faltante").addEventListener("keyup", Validar_Datos_Inventario_KeyUp);

           //document.getElementById("In_Q").addEventListener("change", Validar_Iteracciones_change);


            function Validar_Datos_Inventario() {

              if ($('#In_Q').val().length == 0) {

                    document.getElementById('Tab_Demanda').className = "tab col s2 disabled";
                    var $toastContent = $('<span>Complete Datos de Inventario</span>').add($('<button class="btn-flat toast-action" onclick="Materialize.Toast.removeAll();">Ok</button>'));
                    Materialize.toast($toastContent, 10000);
                    return false;
              }

              if ($('#In_Punto_Reorden').val().length == 0) {
              ...
              if ($('#In_Inventario_Inicial').val().length == 0) {
              ...
              if ($('#In_Costo_Mantenimiento').val().length == 0) {
              ...
              if ($('#In_Costo_Ordenar').val().length == 0) {
              ...
              if ($('#In_Costo_Faltante').val().length == 0) {
                  ...
                  document.getElementById('Tab_Demanda').className = "tab col s2";
                  var $toastContent = $('<span><i class="material-icons">sentiment_very_satisfied</i>Ya Puede ingresar Demanda</span>');
            ...
            function Validar_Datos_Inventario_KeyUp() {
           ...
           function Validar_Key (){
            document.addEventListener("keyup", function(){
                if ($('#In_Demanda').val().length == 0) {
                    document.getElementById('Tab_Retraso').className = "tab col s2 disabled";
                    return false;
              }
             else{
                  document.getElementById('Tab_Retraso').className = "tab col s2";
                 }
           ...
           function Validar_Key_Retraso (){
            document.addEventListener("keyup", function(){
                if ($('#In_Retraso').val().length == 0) {
                    document.getElementById('Tab_Itera').className = "tab col s2 disabled";
                    return false;
              }
             else{
                  document.getElementById('Tab_Itera').className = "tab col s2";
              }
