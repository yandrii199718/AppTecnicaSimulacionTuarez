...
;
        ...
        <!--Script Listener Metodo MCA-->
            ...
            function MetodoMCA () {
                ...
                document.getElementById('formulario').action= "/MLECalcularMCA";
            }
        ...
        <!--Script Listener Metodo MCMU-->
            ...
            function MetodoMCMU () {
                ...
                document.getElementById("CajaMetodos").innerHTML=Metodo;
                document.getElementById('formulario').action= "/MLECalcularMCMU";
            }
        ...
        <!--Script Listener Metodo Manual-->
            ...
            function MetodoManual () {
                ...
                document.getElementById('formulario').action= "/MLECalcularManual";
            }
